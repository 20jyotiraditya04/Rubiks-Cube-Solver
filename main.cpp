...
//    string fileName;
//    fileName = R"(C:\Users\user\CLionProjects\SolvableRubiksCube\Databases\cornerDepth5V1.txt)";
//
...
//    cube.print();
//
//    for (auto move: shuffleMoves) cout << RubiksCubeBitboard::getMove(move) << " ";
//    cout << "\n";
//
...
//
//    idaStarSolver.rubiksCube.print();
//    for (auto move: moves) cout << RubiksCubeBitboard::getMove(move) << " ";
//    cout << "\n";
//
//
//    return 0;
